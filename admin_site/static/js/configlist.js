;(function (BibOS, $) {
  ...
  $.extend(ConfigList.prototype, {
    init: function () {
      ...
      $("#configuration-item-template input").attr("disabled", "disabled")
    ...
    addConfig: function (id, key, value) {
      ...
      var item = $(
        BibOS.expandTemplate("configlist-item", {
          pk: "new_" + num_new,
          key: key,
          value: value,
          submit_name: id,
    ...
    updateNew: function (id) {
      ...
      $("#" + id + " input.config-pk").each(function () {
        ...
        if (t.val().match(/new_^/)) {
          parent.find("input.config-key").attr("name", id + "_" + num + "_key")
          parent
            .find("input.config-value")
            .attr("name", id + "_" + num + "_value")
          $(this).val("new_" + num)
          num++
        }
    ...
    submitEditDialog: function () {
      ...
      if (pk == "new") {
        ...
        var p = $("#" + id).find("input.config-pk[value=" + pk + "]")
