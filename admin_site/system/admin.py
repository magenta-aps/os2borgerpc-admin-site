...
@admin.register(AssociatedScript)
...
@admin.register(AssociatedScriptParameter)
...
@admin.register(EventRuleServer)
...
@admin.register(SecurityProblem)
...
@admin.register(WakeChangeEvent)
